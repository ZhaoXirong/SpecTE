...
save_path = r'./model_test/all/3_epoch1_pretrain_weightdecy/'
...
def objective(trial,dataset_info_pretrain,dataset_info_finetune):
    ...
    try:
        ...
        # 定义当前工作路径
        model_working_path = os.path.join(save_path, "{}_ weight_decay=[{}]/".format(No_i,weight_decay_pretrain))
        No_i=No_i+1
